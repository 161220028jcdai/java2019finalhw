...
import cn.triumphal.frame.donghua;
import javax.swing.*;
...
public class Controller {
    ...
    public void gameOver(){
        ...
        winnerImageView.setImage(emptyImg);
        operationTipImageView.setImage(emptyImg);
        new donghua().fade_out_in(backgroundImageView, new Image(this.getClass().getResourceAsStream("/Background.png")));
    ...
    void clickStartButton(MouseEvent event){
        ...
        new donghua().fade_out_in(backgroundImageView, new Image(this.getClass().getResourceAsStream("/fightScene1.png")));
        Timer timer = new Timer();
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
    ...
    void clickHistoryButton(MouseEvent event){
        ...
        if(file != null && file.exists()) {
            ...
            field = new Field();
            display(field);
            new donghua().fade_out_in(backgroundImageView, new Image(this.getClass().getResourceAsStream("/fightScene2.png")));
            Timer timer = new Timer();
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
